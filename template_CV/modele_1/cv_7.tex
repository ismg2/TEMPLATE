...
\firstname{Ismail} % Your first name
\familyname{Guedira} % Your last name

% All information in this block is optional, comment out any lines you don't need
\title{Curriculum Vitae}
\address{112 Route de Cossonay}{Prilly, Suisse 1008}
...
\photo[70pt][0.5pt]{../pictures/photo} % The first bracket is the picture height, the second is the thickness of the frame around the picture (0pt for no frame)
...
\cventry{2015 -- Actuel}{Échange Universitaire}{EPFL - École Polytechnique Fédéral de Lausanne}{}{}{Section Génie Électrique et électronique}
\cventry{2013 -- 2015}{École d'ingénieur}{Grenoble INP - Phelma (Institut National Polytechnique)}{}{}{Filière Système Électroniques Intégrés, spécialisée dans la microélectronique numérique et analogique, l'électronique hyperfréquence et les systèmes optoélectroniques}
\cventry{2011 -- 2013}{Classe Préparatoires aux Grandes Écoles}{Lycée Descartes}{Tours}{}{Première année en MPSI (Maths Physique et Sciences de l'Ingénieur) et seconde année en $PSI^{*}$ (Physique et Sciences de l'Ingénieur)}
